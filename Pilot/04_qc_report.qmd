...
params:
  ...
  comp_data_path: "Data/Checks/comp_id2486.csv"
execute:
  echo: false
  warning: false
  message: false
...
for(dim in extra_dims) {
  ...
  # Plot: breakdown within country by extra dimension
  p <- ggplot(by_extra, aes(x = "Years", y = "value_data", color = dim)) +
    geom_line(alpha = 0.8) +
    facet_wrap(~Country, scales = "free_y") +
    labs(title = glue::glue("Values over time by {dim} (faceted by Country)")) +
    theme_minimal()
